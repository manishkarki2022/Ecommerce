            ...
            <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <button type="button" onclick="window.location.href='{{ route('authors.index') }}'" class="btn btn-default btn-sm">Reset</button>
                            </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                       ...
                       @if($authors->isEmpty())
                            <tr>
                                <td colspan="7" class="text-danger">No Authors found!!!</td>
                            </tr>
                       @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($author->authorImage->isNotEmpty())
                                            <img src="{{ asset('authorImage/' . $author->id . '/' . $author->authorImage->first()->image) }}" class="img-thumbnail" width="70">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="text-danger w-4 h-4 mr-1" onclick="return confirm('Are you sure you want to delete the data?') ? document.getElementById('delete-form-{{ $author->id }}').submit() : false;">
