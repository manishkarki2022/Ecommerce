                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="text-danger w-4 h-4 mr-1" onclick="return confirm('Are you sure you want to delete the data?') ? document.getElementById('delete-form-{{ $category->id }}').submit() : false;">
